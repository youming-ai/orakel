...
async function fetchLatestRoundData(rpcUrl: string, aggregator: string): Promise<{ answer: ethers.BigNumber; updatedAt: ethers.BigNumber }> {
...
export async function fetchChainlinkPrice(params: { aggregator: string; decimals?: number | null }): Promise<PriceTick> {
